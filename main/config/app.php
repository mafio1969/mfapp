...
return [
     ...
     */
    'debug' => filter_var(env('DEBUG', getenv("DEBUG")), FILTER_VALIDATE_BOOLEAN),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'b8d89d929d4b8de45e1c171c50a17649cbba8f5e73dcc279f2cb2ec4000d26e3'),
    ],
   ...
   //         'host' => 's5.strategie-rozwoju.pl',
            ...
            //'port' => '3306',
//            'username' => 'c2_ccfdev',
//            'password' => 'X|si;~Bc2cg.V68yH>cM',
//            'database' => 'c2_ccfdev',
            'username' => getenv('DATABASE_USER'),
            'password' => getenv('DATABASE_PASSWORD'),
            'database' => getenv('DATABASE_NAME'), //'ccfound',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
