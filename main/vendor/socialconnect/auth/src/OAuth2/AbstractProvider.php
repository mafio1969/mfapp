...
//        $response = $this->httpClient->fromRequest(
        $params = $this->makeAccessTokenRequest($code);
//        );

        $cURLConnection = curl_init($params->getUri());
        curl_setopt($cURLConnection, CURLOPT_POSTFIELDS, $params->getParameters());
        curl_setopt($cURLConnection, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($cURLConnection, CURLOPT_HTTPHEADER, $params->getHeaders());
