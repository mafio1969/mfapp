                        ...
                        <td style="padding: 40px 30px 10px 30px; font-family: 'Quicksand', Arial, sans-serif; ">
                            <table border="0" cellpadding="0" cellspacing="0" style="max-width: 100%">
                                ...
                                <tr>
                                    ...
                                    <?= __('Click the button to activate the account') ?>:
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 10px 0 30px 0;">
                                        ...
                                        ?>" class="btn" target="_blank" style="font-size: 17px; text-transform: uppercase; padding: 9px 23px; color: #fff; text-decoration: none; border-radius: 22px; transition-duration: 0.8s; background-color: #0973ba;"><?= __('activate') ?></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" style="padding: 10px 0 0 0; font-size: 12px;">
                                        <p style="margin-bottom: 0"><?= __('Automatically generated mail, please do not reply to it.') ?></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
