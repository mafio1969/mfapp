...
class AcceptsTable extends CroogoTable
{
    ...
    public function getAcceptItem($acceptId)
    {
        return $this->find()
            ->where(['Accepts.id' => $acceptId])
            ->contain(['Users'])
            ->first();
    }
