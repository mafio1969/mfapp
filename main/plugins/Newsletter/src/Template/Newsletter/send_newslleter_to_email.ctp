                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="max-width: 100%">
                                ...
                                foreach ($newsletter->articles as $article) {
                                    if($i > 0) {
                                        ...
                                        <tr>
                                            <td align="center">
                                                <div style="padding: 9px 19px;">
                                                    ...
                                                    <p style="text-align: left; margin: 11px 10px 10px 0px; font-size: 13px;"><?= $this->Text->truncate(strip_tags($article->description), 100) ?></p>
                                                    <a href="<?= Router::url([
                                                        '_ssl' => true,
                                                        '_host' => 'ccfound.com',
                                                        'prefix' => false,
                                        ...
                                        <tr>
                                            <td>
                                                <div style="background-image: url('https://www.ccfound.com/uploads/<?=  $articles->photo ?>'); background-position: center; background-size: cover; height: 270px;"></div>
                                                <table border="0" cellpadding="10" cellspacing="0" style="width: 100%">
                                                    <tr style="background-color: #132133; color: #fff; font-family: 'Montserrat', Arial, sans-serif; font-size: 14px; padding: 9px 19px;">
                                                        <td align="left">
                                                            <p style="font-size: 14px;"><?= $articles->title ?></p>
                                                        </td>
                                                        <td align="right">
                                                            <a href="<?= Router::url([
                                                                '_ssl' => true,
